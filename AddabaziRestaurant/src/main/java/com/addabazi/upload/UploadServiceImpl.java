...
@Service
public class UploadServiceImpl implements Serializable, UploadService{
  ...
  @Override
    public void uploadService(String imgPath, String fileName,UploadedFile uploadFile)
    {
        ...
        String filepath = servletContext.getRealPath("/uploaded/"+imgPath) + File.separator + fileName;
